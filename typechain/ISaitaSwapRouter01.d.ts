...
interface ISaitaSwapRouter01Interface extends ethers.utils.Interface {
  functions: {
...
export class ISaitaSwapRouter01 extends BaseContract {
  ...
  interface: ISaitaSwapRouter01Interface;
