...
interface ISaitaSwapFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class ISaitaSwapFactory extends BaseContract {
  ...
  interface: ISaitaSwapFactoryInterface;
