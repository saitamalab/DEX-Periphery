...
interface ISaitaSwapRouter02Interface extends ethers.utils.Interface {
  functions: {
...
export class ISaitaSwapRouter02 extends BaseContract {
  ...
  interface: ISaitaSwapRouter02Interface;
