...
interface SaitaSwapRouter01Interface extends ethers.utils.Interface {
  functions: {
...
export class SaitaSwapRouter01 extends BaseContract {
  ...
  interface: SaitaSwapRouter01Interface;
